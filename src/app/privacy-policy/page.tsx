      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6 text-xs sm:text-sm text-gray-300 leading-relaxed">
          <section className="space-y-2">
            <h2 className="text-base font-bold text-gray-100">1. Information We Collect</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-base font-bold text-gray-100">2. How We Use Your Information</h2>
            <p>Your details are used strictly for:</p>
            <ul className="pl-4 list-disc space-y-1 text-gray-400">
          ...
          <section className="space-y-2">
            <h2 className="text-base font-bold text-gray-100">3. No Third-Party Sharing or Spam</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-base font-bold text-gray-100">4. Contacting Us Regarding Your Data</h2>
            <p>
              For any questions regarding your privacy or to update your saved contact details, please email us at <strong className="text-gold-400">{settings.email}</strong> or message us on WhatsApp at <strong className="text-gold-400">{settings.whatsapp}</strong>.
            </p>
          </section>
        </div>
      </div>
